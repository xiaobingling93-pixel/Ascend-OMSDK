...
- [获取软件包](./docs/zh/user_guide/installation_guide.md#获取软件包)
- [准备安装环境](./docs/zh/user_guide/installation_guide.md#准备安装环境)
- [通过命令行安装](./docs/zh/user_guide/installation_guide.md#通过命令行安装)
