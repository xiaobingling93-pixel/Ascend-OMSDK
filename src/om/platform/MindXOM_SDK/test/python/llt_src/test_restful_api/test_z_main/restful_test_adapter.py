...
class RestfulTestAdapter:
    ...
    def setup_class(self):
        self.token_patch = patch("ibma_redfish_urls.get_privilege_auth", return_value=MockPrivilegeAuth)
        ...
        AbilityConfig.CONFIG_FILE = os.path.join(project_dir, '../ibma/config/ability_policy_allow_all.json')
