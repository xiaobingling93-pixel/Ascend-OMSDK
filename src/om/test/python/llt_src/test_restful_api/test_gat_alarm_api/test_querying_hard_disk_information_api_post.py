...
class TestCreateNewSessionFailed(PostTest):
    """2.4.1 查询硬盘信息"""
    COMPUTER_SYSTEM_RESET_URL = "/redfish/v1/UpdateHddService/HddInfo"
...
def test_querying_hard_disk_information():
            ...
            {"error": {"code": "Base.1.0.GeneralError",
                       ...
                       "@Message.ExtendedInfo": [
                           {"@odata.type": "#MessageRegistry.v1_0_0.MessageRegistry",
                            ...
                            "Resolution": "None",
                            "Oem": {"status": None}}]}}),
        label="test querying_hard_disk_information failed due to Parameter is invalid for HddNo",
        code=400,
        data={
            "HddNo": 3
        })
